...
activities = {
    ...
    "Art Club": {
        ...
        "max_participants": 18,
        "participants": ["isabella@mergington.edu", "zach@mergington.edu"]
    },
    "Drama Club": {
        "description": "Work on acting, stage production, and school performances",
        "schedule": "Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["laura@mergington.edu", "kyle@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice public speaking and compete in debate tournaments",
        "schedule": "Mondays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["noah@mergington.edu", "rachel@mergington.edu"]
    },
    "Math Olympiad": {
